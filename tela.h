	...
	for (linha = 0; linha < LINHAS_TABULEIRO; linha++) {
		...
		for (coluna = 0; coluna < COLUNAS_TABULEIRO; coluna++) {
			switch (pecas[linha][coluna].tipo) {
				case REI_BRANCO:
					printf("%s\x20\x20","\xe2\x99\x9a");
					break;
				case REI_PRETO:
					printf("%s\x20\x20","\xe2\x99\x94");
					break;
				case PEAO_BRANCO:
					printf("%s\x20\x20","\xe2\x99\x9f");
					break;
				case PEAO_PRETO:
					printf("%s\x20\x20","\xe2\x99\x99");
					break;
				case BISPO_PRETO:
					printf("%s\x20\x20","\xe2\x99\x97");
					break;
				case BISPO_BRANCO:
					printf("%s\x20\x20","\xe2\x99\x9d");
					break;
				case RAINHA_PRETO:
					printf("%s\x20\x20","\xe2\x99\x95");
					break;
				case RAINHA_BRANCO:
					printf("%s\x20\x20","\xe2\x99\x9b");
					break;
				case TORRE_BRANCO:
					printf("%s\x20\x20","\xe2\x99\x9c");
					break;
				case TORRE_PRETO:
					printf("%s\x20\x20","\xe2\x99\x96");
					break;
				case CAVALO_PRETO:
					printf("%s\x20\x20","\xe2\x99\x98");
					break;
				case CAVALO_BRANCO:
					printf("%s\x20\x20","\xe2\x99\x9e");
					break;
				case ESPACO_VAZIO:
					printf("\x20\x20\x20");
					break;
